...
export const routeInfo: Record<RouteKey, {
  ...
  "50": {
    ...
    description: "每天只需关注五项基础生活挑战；另外五项可选挑战只是自由参考，不要求完成。",
    structure: "每日5项基础挑战＋5项自由参考",
    target: "累计获得40个达标日",
  },
};
...
export const routeDetails: Record<RouteKey, {
  ...
  "50": {
    groups: [
      ...
      { label: "可选参考（完全不强制）", items: ["阅读：至少10分钟", "学习新技能：至少30分钟", "屏蔽信息流：至少2小时", "身体觉察：至少10分钟", "创造性输出：完成一次具体产出"] },
    ],
    rules: ["每天只统计5项基础挑战：完成4项记为1个达标日，5项全部完成记为1个全部完成日。", "五项可选挑战完全不强制，只提供行动参考；完成后可累计次数，但不影响达标日或全部完成日判定。", "50天内累计获得至少40个达标日（包括全部完成日），即完成本轮挑战。"],
  },
};
