...
> = {
  "7": {
    days: 7,
    name: "7日清场",
    label: "适合：生活很乱，不知道先做什么",
    description: "每天处理一个具体阻力，例如信息流、空间或积压事项；任务更少，先把生活重新变得可用。",
    structure: "每日1个主挑战＋2个小锚点 · 完成5天及回序卡",
    target: "完成5个主挑战，并留下回序卡",
  },
  "21": {
    days: 21,
    name: "21日稳定",
    label: "适合：能行动，但日常节奏不稳定",
    description: "每天保持起居、身体与注意力三个锚点，再用七组三日挑战逐步照顾饮食、连接和生活准备。",
    structure: "每日3个固定锚点＋1个轮换挑战 · 获得15个稳定日",
    target: "获得15个稳定日，参与5组轮换挑战",
  },
  "50": {
    days: 50,
    name: "50日挑战",
    label: "适合：已有基础，能承担多项行动",
    description: "连续五十天实践起床、晨间、活动、饮食、归位和晚间收尾，建立一套完整而长期的生活规则。",
    structure: "每日6项基础挑战＋2项可选成长 · 累计40个达标日",
    target: "累计获得40个达标日",
  },
};
